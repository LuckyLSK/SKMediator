...
NSString * const kSKMediatorParamsKeySwiftTargetModuleName = @"kSKMediatorParamsKeySwiftTargetModuleName";
...
- (id)performTarget:(NSString *)targetName
  ...
  shouldCacheTarget:(BOOL)shouldCacheTarget{
    ...
    NSString *swiftModuleName = params[kSKMediatorParamsKeySwiftTargetModuleName];
...
- (NSMutableDictionary *)cachedTarget{
    if (!_cachedTarget) {
        _cachedTarget = [NSMutableDictionary dictionaryWithCapacity:1];
    }
